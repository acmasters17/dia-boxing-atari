...
class DefensiveJugglingReactiveAgent(Agent):
    def __init__(self):
        super().__init__()
    ...
    def juggleBetweenFists(self):
        ...
        if(self.lastAction == BoxingAction.MOVE_RIGHT or self.lastAction == BoxingAction.MOVE_LEFT):
        ...
        if(self.lastAction == BoxingAction.FIRE_MOVE_UP):
            ...
            self.midCombo = False
            # Backs up after combo
            return BoxingAction.MOVE_LEFT
        else:
